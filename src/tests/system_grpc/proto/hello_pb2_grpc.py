...
class HelloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A system_grpc.Channel.
        """
        self.sayHello = channel.unary_unary(
                '/ru.gatling.system_grpc.HelloService/sayHello',
...
def add_HelloServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ru.gatling.system_grpc.HelloService', rpc_method_handlers)
...
class HelloService(object):
    ...
    def sayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ru.gatling.system_grpc.HelloService/sayHello',
            proto_dot_hello__pb2.HelloRequest.SerializeToString,
            proto_dot_hello__pb2.HelloReply.FromString,
