...
class Accounts(HttpUser):
    ...
    def on_start(self) -> None:
        ...
        #     "src/resources/tests/reqres/fake_bank.json",
        #     "src/resources/tests/reqres/__groups/reqres_host.json",
        #     "src/resources/tests/reqres/t01_create_users/create_users_properties.json"
        # )
        # self.profile = {}
